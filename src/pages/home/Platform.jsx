...
const Platform = () => {
  return (
    <div className="bg-gray-600 p-3 pt-10 w-[430px] rounded-3xl h-[540px]">
      ...
      <p className="bg-gray-600 text-center mt-6 text-[18px] leading-7">
      ...
      <br />
      <p className="bg-gray-600 text-center text-[18px] leading-7">
      ...
      <p className="bg-gray-600 text-center text-[18px] mt-6 leading-7">
